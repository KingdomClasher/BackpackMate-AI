...
>(({ side = 'right', label, onClick, layoutId, position = 'fixed' }, ref) => {
	...
	return (
		...
		<button
			...
			className='flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2 text-xs font-medium text-slate-700 shadow-sm transition hover:border-slate-400 hover:text-slate-900'>
			<span className='rounded-full bg-slate-200 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.2em] text-slate-600'>AI</span>
